                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="/addcontract">Add Contract</a></li>
                            <li><i class="fa fa-table"></i><a href="/manage/contract">Manage Contract</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <h3 class="menu-title">Master Works</h3><!-- /.menu-title -->

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-user-plus"></i>{{$array['general']['add']}}</a>
                        <ul class="sub-menu children dropdown-menu">
                    <li class="active">
                        <a href="/add/superadmin"> <i class="menu-icon fa fa-users"></i>{{$array['general']['add']}} {{$array['general']['superadmin']}}</a>
                    </li>
                    <li class="active">
                        <a href="/add/systemuser"> <i class="menu-icon fa fa-users"></i>{{$array['general']['add']}} {{$array['general']['systemuser']}}</a>
                    </li>
                    </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                             ...
                             <li class="active">
                        <a href="/manage/superadmin"> <i class="menu-icon fa fa-users"></i>{{$array['general']['manage']}} {{$array['general']['superadmin']}}</a>
                    </li>

                    <li class="active">
                        <a href="/manage/systemuser"> <i class="menu-icon fa fa-users"></i>{{$array['general']['manage']}} {{$array['general']['systemuser']}}</a>
                    </li>
