                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{$array['manage']['name']}}</th>
                                            <th>Email</th>
                                            <th><th>{{$array['manage']['merchantid']}}</th></th>
                                            <th>{{$array['manage']['delete']}}</th>
                                            @elseif ($tur=='user')
                                            <th>{{$array['manage']['id']}}</th>
                                            <th>{{$array['manage']['name']}}</th>
                                            <th>Email</th>
                                            <th>{{$array['manage']['merchantid']}}</th>
                                            <th>{{$array['manage']['delete']}}</th>
                                            @endif
                                        </tr>
                                    </thead>
                                        ...
                                        @if($tur=='merchant')
                                         @foreach($merchants as $merchant)
                                           <tr>
                                            ...
                                            <td><button type="button" onclick="location.href='/addmerchant/{{ $merchant->id }}'" class="btn btn-success">Edit</button><button type="button" onclick="myclFunction({{ $merchant->id }})" class="btn btn-danger">Delete</button></td>
                                        </tr>
                                        @endforeach
                                            @elseif ($tur=='admin')
