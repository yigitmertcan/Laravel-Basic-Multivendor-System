                ...
                <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="/wantadduser" method="post" class="">
                                            @csrf
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="select122" id="select" class="form-control">
                                                        <option value="0">New User</option>
                                                       
                                                        <option value=""> gfdgfdg</option>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Group:</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <select name="select123" id="select" class="form-control">
                                                        <option value="0">Default</option>
                                                       
                                                        <option value=""> fwfewf</option>
